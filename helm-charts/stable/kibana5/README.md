...
```console
$ helm install yonyouccs/kibana5
```
...
```console
$ helm install --name my-release yonyouccs/kibana5
```

The command deploys kibana5 on the Kubernetes cluster in the default configuration. The [configuration](#configuration) section lists the parameters that can be configured during installation.
...
| `image.repository`            | Tomcat Image name                            | `yonyouccs/kibana5`                                          |
